...
Functional programming and object-oriented programming are two different programming paradigms. There is no universal definition for either of them, but in order to reason about them we need choose one. Following is therefore how they are going to be defined in this thesis.
