...
What if a an object's method is both locally and parametrically impure? Just like in the previous cases, as long as the object is fresh the purity of the caller is not affected.
...
Due to the choice of purity definition including non-determinism, which is not included in some definitions of functional purity, the analysis was somewhat simplified.
