...
\subsection{The C\# Language and .NET} \label{sub:The C\# Language}
C\# is a type safe object oriented programming language developed by Microsoft~\cite{intro-to-Csharp}. Most C\# applications use the .NET ecosystem.
