...
\begin{table}[H]
  ...
  \begin{tabular}{|l|ll|}
    ...
    \hline
    \textbf{Classification of pure methods}   & 19\%               & 2\%             \\
    \textbf{Classification of impure methods} & 63\%               & 59\%            \\
    \hline
  \end{tabular}
\end{table}
...
While not nearly as much, the 8\% of methods with no \texttt{[Pure]} attribute also contribute in part to the 59\% impure classification recall. However, the most contributing factor reducing the impure classifiation recall is the 33\% of \texttt{[Pure]}s classified as \textit{unknown}.
