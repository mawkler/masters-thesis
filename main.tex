...
\subsection{Results from running CsPurity on Microsoft's .NET Reference Source \texttt{String} and \texttt{Encoding} class} \label{sub:results-string-class}
